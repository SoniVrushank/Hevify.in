...
def render(b, related):
    ...
    return HEAD.format(title=b["title"],desc=b["desc"],kw=b["kw"],slug=b["slug"],schema=schema_for(b),
        cat=b["cat"],h1=b["h1"],author=b["author"],date="July 24, 2026",read=b["read"],
...
BLOGS.append(dict(
 slug="why-we-publish-our-prices", cat="Values", author="Vrushank Soni", read=4,
 title="How Much Does a Marketing Agency Cost in India? | Hevify Labs",
 desc="How much does a marketing agency cost in India? Real starting prices, what affects them, and why Hevify Labs publishes ours instead of hiding behind a 'book a call'.",
 kw="marketing agency pricing, transparent pricing agency, performance marketing agency cost, how much does a digital marketing agency cost India",
 keywords_chips=["transparency","agency pricing","trust","Ahmedabad"],
 h1='How Much Does a Marketing Agency Cost in India? <span class="serif">Here\'s Ours</span>',
 tldr="We list starting prices for every package on our homepage — ₹6,000/mo for SEO & GEO, ₹8,000/mo for Performance Marketing, ₹10,000/mo for Social Media — because hiding pricing behind a 'book a call' wall wastes everyone's time. We don't do that.",
 body="""
<h2>How much does a marketing agency cost in India?</h2>
<p>How much does a marketing agency cost in India? Most small businesses find out the hard way — after a sales call, not before. Search for almost any marketing agency and you'll notice a pattern: glowing case studies, confident claims, a big "Get a Proposal" button — and no number anywhere in sight. You have to book a call, sit through a pitch, and only then find out if the budget even matches what you expected.</p>
<p>We think that's backwards. If you're a founder or a marketing lead trying to figure out whether an agency fits your budget, the price is often the <em>first</em> thing you need to know — not the last. Here's what a <a href="../performance-marketing-agency-ahmedabad.html">performance marketing</a>, <a href="../social-media-marketing-agency-ahmedabad.html">social media</a> or <a href="../seo-geo-agency-ahmedabad.html">SEO &amp; GEO</a> retainer actually costs, and why we publish it.</p>
<h2>Why we do it differently</h2>
<p><strong>It respects your time.</strong> You shouldn't need a 30-minute call to learn a number that could have ruled us out in five seconds.</p>
<p><strong>It filters for fit, not just leads.</strong> Publishing prices means the people who reach out already know roughly what they're signing up for — fewer mismatched expectations, fewer awkward conversations three weeks in.</p>
<p><strong>It's a small, honest signal.</strong> Anyone can promise real results. Publishing a number you can hold us to is a cheaper thing to say and a harder thing to fake.</p>
<h2>The trade-off, honestly</h2>
<p>Publishing a starting price means some people rule us out before we get to make our case. That's fine — we'd rather have that conversation upfront than after weeks of work. If you're still comparing options, our guide on <a href="best-performance-marketing-agency-ahmedabad.html">what to look for in a performance marketing agency</a> covers the other things worth checking beyond price.</p>
""",
 faqs=[
   ("Are these prices final?","They're starting prices per package. Final scope depends on channels, ad spend and how much is being managed — we'll always confirm the real number before anything is signed."),
   ("Why isn't ad spend included?","So you always control that budget directly, rather than paying us a marked-up version of it."),
   ("Is a cheaper agency automatically worse?","No — but a price nobody will tell you isn't a sign of anything good either."),
 ]))

BLOGS.append(dict(
 slug="what-we-turn-down", cat="Values", author="Vrushank Soni", read=4,
 title="How to Spot a Good Marketing Agency (Before You Sign) | Hevify Labs",
 desc="How do you spot a good marketing agency before signing anything? The clearest signal is what they're willing to turn down. Here's what we say no to, and why.",
 kw="marketing agency client fit, choosing a marketing agency, agency red flags, right agency for my business",
 keywords_chips=["client fit","agency values","Ahmedabad"],
 h1='How to Spot a <span class="serif">Good Marketing Agency</span>',
 tldr="We turn down projects with no tracking in place, budgets too thin to test properly, and timelines that expect month-one miracles — because taking them on quietly sets everyone up to be disappointed. Here's what we say no to, and what we say yes to instead.",
 body="""
<h2>What separates a good marketing agency from a risky one</h2>
<p>A good marketing agency is easier to spot by what it turns down than by what it promises. Every agency says yes to almost everything — a bigger client list looks good on a homepage. We'd rather have a shorter list of brands we've actually helped grow. If you're evaluating anyone, including us, this is a fair way to check.</p>
<h2>What we say no to</h2>
<p><strong>No way to track results.</strong> If there's no way to measure what's working — no pixel, no CRM, no clear goal — we won't take the retainer. Spending your money without a way to prove it worked isn't a service, it's a guess.</p>
<p><strong>Budgets too thin to learn anything.</strong> Ad platforms need a minimum spend just to gather enough data to optimise. Below that, we're not testing — we're burning money slowly.</p>
<p><strong>"We need results by next week."</strong> Paid ads and SEO both need real weeks to show signal. We'll tell you honestly what's realistic before you sign anything, not after.</p>
<h2>What we say yes to</h2>
<p>Brands with a real offer, a way to track what happens, and enough budget to actually test. That's the combination that lets <a href="../performance-marketing-agency-ahmedabad.html">performance marketing</a>, social or SEO work the way it's supposed to. Google's own guidance on <a href="https://developers.google.com/search" target="_blank" rel="noopener">what makes content and campaigns rank well</a> says much the same thing — the fundamentals have to be in place first, no shortcut replaces them. For the full pattern of what goes wrong without them, see <a href="how-to-choose-the-right-marketing-partner.html">how to choose the right marketing partner</a>.</p>
""",
 faqs=[
   ("Does this mean small businesses can't work with you?","No — several of our clients started small. The requirement is having enough budget and tracking to test properly, not a minimum company size."),
   ("What if I don't have tracking set up yet?","We can set it up as part of onboarding — the requirement is that it exists before spend starts, not that you arrive with it already built."),
   ("Will you tell me if my expectations are unrealistic?","Yes, upfront and directly — that's the point of this policy."),
 ]))

BLOGS.append(dict(
 slug="best-performance-marketing-agency-ahmedabad", cat="Guide", author="Dev Prajapati", read=6,
 title="Best Performance Marketing Agency in Ahmedabad: What to Look For (2026) | Hevify Labs",
 desc="A practical checklist for choosing the best performance marketing agency in Ahmedabad — what to ask, what to check, and the red flags worth walking away from.",
 kw="best performance marketing agency Ahmedabad, top performance marketing agency Ahmedabad, how to choose a marketing agency, performance marketing agency checklist",
 keywords_chips=["best agency Ahmedabad","agency checklist","performance marketing","how to choose"],
 h1='Best Performance Marketing Agency in <span class="serif">Ahmedabad</span>',
 tldr="The best performance marketing agency for you is the one that shows real tracking, is honest about timelines, and reports on revenue — not reach. Check for transparent pricing, a clear reporting cadence, and proof they can explain in plain language, not jargon.",
 body="""
<h2>Why "best" depends on fit, not fame</h2>
<p>The best performance marketing agency in Ahmedabad isn't necessarily the biggest one. Ahmedabad has dozens of agencies claiming that title — some have been around for a decade with big client rosters, some are small, focused teams. Neither size guarantees results — what matters is whether their process fits how your business actually needs to grow.</p>
<h2>What to actually check</h2>
<h3>1. Do they talk about tracking before they talk about creative?</h3>
<p>An agency that leads with reels and ad mockups before asking how you'll measure success is optimising for looking good, not for your ROI. Tracking should be step one of any conversation.</p>
<h3>2. Is pricing clear upfront?</h3>
<p>Agencies that won't share even a starting price until after a sales call are usually pricing based on what they think you'll pay, not a fixed rate card.</p>
<h3>3. Do they set realistic timelines?</h3>
<p>Paid ads can show early signal in a few weeks; real, stable results take 2–3 months of testing. Anyone promising overnight transformation is setting you up for disappointment — or hiding the real timeline until you've signed.</p>
<h3>4. Can they explain what they're doing in plain language?</h3>
<p>If a monthly report is a wall of jargon and no clear number, that's usually covering for a lack of a clear number to report.</p>
<h3>5. Do they show real numbers, not just logos?</h3>
<p>A client logo wall proves nothing on its own. Ask what specific outcome they drove — cost per lead, ROAS, retention — and expect a real answer.</p>
<h2>A short checklist</h2>
<ul>
<li>Tracking and conversion measurement set up before spend starts</li>
<li>Transparent starting pricing, not "contact us for a quote"</li>
<li>A realistic timeline, stated upfront</li>
<li>Reporting in plain language, tied to revenue</li>
<li>Willing to say no to a bad-fit project rather than take your money regardless</li>
</ul>
<p>For the full story of what happens when these checks get skipped, read <a href="how-to-choose-the-right-marketing-partner.html">how to choose the right marketing partner</a>. And if you want to see exactly what a transparent <a href="../performance-marketing-agency-ahmedabad.html">performance marketing</a> package looks like, including price, that's on our services page — Google's own <a href="https://ads.google.com" target="_blank" rel="noopener">Google Ads</a> platform is the one most of that spend tends to run through.</p>
""",
 faqs=[
   ("How do I know if a performance marketing agency in Ahmedabad is good?","Check that they lead with tracking and measurement, price transparently, set realistic timelines, and report in plain language against real business outcomes rather than reach or impressions."),
   ("What's a fair starting budget for performance marketing in Ahmedabad?","Many small businesses start with a management fee from ₹8,000/mo plus a separate, sustainable ad spend budget — enough for platforms to gather real data over 60–90 days."),
   ("Should I choose the biggest agency or the most specialised one?","Neither guarantees results. What matters is whether their process — tracking, pricing, honesty about timelines — fits how your business needs to grow."),
 ]))

BLOGS.append(dict(
 slug="how-to-choose-the-right-marketing-partner", cat="Guide", author="Vrushank Soni", read=6,
 title="How to Choose a Good Digital Marketing Agency (Red Flags) | Hevify Labs",
 desc="How do you choose a good digital marketing agency and avoid the red flags? A real pattern we've seen — months and thousands of rupees lost to inexperience — and what to check before you pay anyone.",
 kw="how to choose a digital marketing agency, marketing agency red flags, avoid bad SEO agency, freelancer vs agency, marketing partner checklist",
 keywords_chips=["choosing a partner","red flags","SEO","Meta ads"],
 h1='How to Choose a Good Digital Marketing Agency <span class="serif">(Red Flags to Avoid)</span>',
 tldr="A business we later worked with had already spent 6 months and a meaningful budget on organic SEO with an inexperienced freelancer, plus thousands more on Meta ads with no real strategy behind them — and had nothing to show for either. The fix isn't avoiding freelancers or agencies outright; it's checking a few specific things before you pay anyone.",
 body="""
<h2>A pattern we see more than we'd like</h2>
<p>Choosing a good digital marketing agency is mostly about knowing which red flags to check for before you pay anyone. Before working with us, one business had already paid for six months of "organic SEO" from someone hired mainly on price, with very little actual experience. No ranking movement, no reporting that meant anything, no clear plan — just a monthly invoice. Separately, they'd put a meaningful budget into <a href="https://www.facebook.com/business/ads" target="_blank" rel="noopener">Meta ads</a> with no real targeting strategy behind it, and the money was gone with nothing to point to.</p>
<p>This isn't a story about one bad freelancer. It's a pattern worth knowing about before you spend anything with anyone — including us.</p>
<h2>What actually went wrong</h2>
<p><strong>No baseline, no goal.</strong> Work started without agreeing what "working" would even look like — no starting rankings recorded, no target, no timeline.</p>
<p><strong>No reporting that meant anything.</strong> Monthly updates were activity lists ("published 4 blogs," "did keyword research") with no connection to actual rankings, traffic or leads.</p>
<p><strong>Ad spend with no strategy.</strong> Meta ads were switched on without a clear audience, offer or tracking — spend without a way to know if it worked.</p>
<p><strong>Nobody asked hard questions upfront.</strong> The business didn't know what to ask, and the freelancer didn't offer the information unprompted.</p>
<h2>What to check before you pay anyone</h2>
<ul>
<li>Ask for a specific example of a result they've driven — a number, not a description.</li>
<li>Ask exactly how you'll be able to tell, month to month, whether it's working.</li>
<li>Ask what happens if it isn't working by month three.</li>
<li>Check that tracking is set up <em>before</em> any spend starts, not after.</li>
<li>Be wary of anyone who can't explain their plan in plain language.</li>
</ul>
<h2>The real lesson</h2>
<p>Price isn't the problem — inexperience dressed up as a low price is. The cheapest option and the most expensive option can both fail the same way: no tracking, no plan, no accountability. What protects you is asking a few direct questions before you sign anything, with anyone. Our <a href="best-performance-marketing-agency-ahmedabad.html">checklist for choosing a performance marketing agency</a> and our note on <a href="what-we-turn-down.html">how to spot a good marketing agency</a> both cover this from the agency's side, if you want the fuller picture. We also publish our <a href="../performance-marketing-agency-ahmedabad.html">own pricing</a> for the same reason.</p>
""",
 faqs=[
   ("How do I check if someone is experienced enough for SEO or ads?","Ask for a specific, numbered result they've achieved before, not a general description of services — genuine experience is easy to describe concretely."),
   ("Is it safer to hire an agency instead of a freelancer?","Not automatically — the same checks (tracking, clear goals, honest reporting) matter regardless of size. Inexperience can show up at either."),
   ("What should I do if I'm already in this situation?","Ask for a clear report of exactly what's been done and what changed as a result. If there's no clear answer after a few months, that itself is the answer."),
 ]))
...
short = {
 ...
 "why-we-publish-our-prices":"Why We Publish Our Prices",
 "what-we-turn-down":"What We Turn Down (And Why)",
 "best-performance-marketing-agency-ahmedabad":"Best Performance Marketing Agency in Ahmedabad",
 "how-to-choose-the-right-marketing-partner":"How to Choose the Right Marketing Partner",
}
