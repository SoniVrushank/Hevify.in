...
.postHero{width:100%;line-height:0;background:var(--ink)}
.postHero svg{display:block;width:100%;height:220px}
@media(max-width:560px){.postHero svg{height:150px}}
"""
...
HERO_ART = {
 "performance-marketing-guide": '<svg viewBox="0 0 400 200" preserveAspectRatio="none"><defs><linearGradient id="g1" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#C6F24E"/><stop offset="1" stop-color="#9FD11A"/></linearGradient></defs><rect width="400" height="200" fill="url(#g1)"/><path d="M0 150 L80 120 L160 140 L240 80 L320 100 L400 40" stroke="#111113" stroke-width="4" fill="none"/><circle cx="240" cy="80" r="7" fill="#111113"/></svg>',
 "social-media-growth-strategy": '<svg viewBox="0 0 400 200" preserveAspectRatio="none"><rect width="400" height="200" fill="#111113"/><circle cx="130" cy="100" r="46" fill="none" stroke="#C6F24E" stroke-width="4"/><circle cx="130" cy="100" r="14" fill="#C6F24E"/><circle cx="285" cy="70" r="8" fill="#C6F24E"/><path d="M176 100 H340" stroke="#3a3a42" stroke-width="3"/></svg>',
 "meta-ads-for-leads": '<svg viewBox="0 0 400 200" preserveAspectRatio="none"><defs><linearGradient id="g3" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#E8622C"/><stop offset="1" stop-color="#111113"/></linearGradient></defs><rect width="400" height="200" fill="url(#g3)"/><path d="M150 60 h100 v50 l-30 -18 v40 h-40 v-40 l-30 18 z" fill="#F7F6F3" opacity=".92"/></svg>',
 "geo-ai-search-optimization": '<svg viewBox="0 0 400 200" preserveAspectRatio="none"><rect width="400" height="200" fill="#111113"/><rect x="150" y="70" width="100" height="60" rx="14" fill="none" stroke="#C6F24E" stroke-width="4"/><circle cx="178" cy="100" r="6" fill="#C6F24E"/><circle cx="222" cy="100" r="6" fill="#C6F24E"/><path d="M200 70 v-16 M200 54 h18" stroke="#C6F24E" stroke-width="4" fill="none"/></svg>',
 "local-seo-ahmedabad": '<svg viewBox="0 0 400 200" preserveAspectRatio="none"><defs><linearGradient id="g5" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#2E5BFF"/><stop offset="1" stop-color="#9FD11A"/></linearGradient></defs><rect width="400" height="200" fill="url(#g5)"/><path d="M200 46 c-26 0 -46 20 -46 46 c0 34 46 66 46 66 c0 0 46 -32 46 -66 c0 -26 -20 -46 -46 -46 z" fill="#F7F6F3"/><circle cx="200" cy="92" r="16" fill="#111113"/></svg>',
 "google-ads-small-business-india": '<svg viewBox="0 0 400 200" preserveAspectRatio="none"><rect width="400" height="200" fill="#111113"/><rect x="120" y="120" width="34" height="40" fill="#2E5BFF"/><rect x="170" y="96" width="34" height="64" fill="#E8622C"/><rect x="220" y="72" width="34" height="88" fill="#C6F24E"/><rect x="270" y="52" width="34" height="108" fill="#9FD11A"/></svg>',
}
def hero_for(slug):
    return '<div class="postHero">%s</div>' % HERO_ART[slug]
...
def render(b, related):
    ...
    return HEAD.format(title=b["title"],desc=b["desc"],kw=b["kw"],slug=b["slug"],schema=schema_for(b),
        ...
        tldr=b["tldr"],keys=keys,body=b["body"],faqhtml=faqhtml,rel=rel,hero=hero)
