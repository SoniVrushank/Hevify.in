...
(function(){
  ...
  // (page-load fade-in is now pure CSS — no JS step needed here)
  ...
  // Scroll reveal (progressive enhancement — elements are visible by default in CSS;
  // JS "arms" them with the hidden starting state only once it's confirmed to be running,
